package com.adidas.publicservice.controller.api;
...
import com.adidas.publicservice.exception.ErrorResponse;
...
public interface IPublicController {
    ...
    @GetMapping(value = "/subscriptions/{idSubscription}",
            produces = {MediaType.APPLICATION_JSON_VALUE})
	public ResponseEntity<SubscriptionDto> getSubscription(@PathVariable("idSubscription") Long idSubscription);
